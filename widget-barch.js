(function () {
    ...
    // ===============================================
    const apiKey = "pl_live_51e93c0e094fc563e86e4b4d3b6379bea0ad5453942ba1e8dd28e0bc5d5a48cd";
    ...
    const WEBHOOK_CHECK_LIMIT = 'https://n8n.segredosdodrop.com/webhook/barch-check-limit';
            ...
            <div class="q-card-ia">
                ...
                <div class="q-content-scroll">
                    ...
                    <div id="q-header-provador">
                        ...
                        <img src="https://acdn-us.mitiendanube.com/stores/004/982/616/themes/common/logo-6628445411204466754-1777675117-e2457ea4d103baf41ed0b9598683ef981777675117-480-0.webp" alt="Barch Ótica" style="height:54px;width:auto;"/>
                    </div>
            ...
            try {
                ...
                if (pending) {
                    ...
                    const resp = await fetch(WEBHOOK_PIX, {
                        method: 'POST',
                        headers: { 'Content-Type': 'application/json' },
                        body: JSON.stringify({ email: 'cliente@provoulevou.com.br', phone, loja: 'barch', origin: location.origin })
                    });
                    pix = await resp.json();
